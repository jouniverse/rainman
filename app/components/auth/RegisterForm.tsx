    ...
    <div className="w-full max-w-md p-8 space-y-8 bg-white/10 backdrop-blur-md shadow-2xl rounded-lg">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        <div className="rounded-md shadow-sm -space-y-px">
          ...
          <div>
            ...
            <input
              ...
              type="password"
              required
              className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm bg-black/30"
        ...
        <div>
          ...
          >
            {isLoading ? <div className="loader-pixels"></div> : 'Create account'}
          </button>
        </div>
      </form>
    </div>
